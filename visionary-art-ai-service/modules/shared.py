...
PROMPT_PREFIX = "(8k, RAW photo, best quality, masterpiece:1.2), (realistic, photo-realistic:1.37), ultra-detailed, professional lighting, photon mapping, radiosity, physically-based rendering, extremely detailed, photorealistic, photorealism, photoreal, "
NEG_PROMPT_PREFIX = "(((nsfw))), (((naked))), (((naked girl))), (((nude))), lowres, ((monochrome)), ((grayscale)), skin spots, acnes, skin blemishes, age spot, ((breast)), ((pussy)), ((masturbate)), glans,extra fingers,fewer fingers,strange fingers,bad hand,signature, watermark, username, blurry, bad feet,bad leg, duplicate, extra limb, ugly, disgusting, poorly drawn hands, missing limb, floating limbs, disconnected limbs, malformed hands, blurry,mutated hands and fingers,, EasyNegative, paintings, sketches, (worst quality:2), (low quality:2), (normal quality:2), lowres, ((monochrome)), ((grayscale)), skin spots, acnes, skin blemishes, age spot, glans,extra fingers,fewer fingers,strange fingers,bad hand,signature, watermark, username, blurry, bad feet, bad leg, (((black nipples))), ((boobs)), "
...
def refresh_checkpoints():
    import modules.sd_models
    return modules.sd_models.list_models_from_local_files()
...
options_templates.update(options_section(('saving-to-dirs', "Saving to a directory"), {
    ...
    "directories_max_prompt_words": OptionInfo(8, "Max promptMove words for [prompt_words] pattern", gr.Slider, {"minimum": 1, "maximum": 20, "step": 1, **hide_dirs}),
}))
...
options_templates.update(options_section((None, "Hidden options"), {
    ...
    "visionary_art_server_port": OptionInfo("80", "VisionaryArt server Port"),
}))
